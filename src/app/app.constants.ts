...
export const DEFAULT_ISSUES = [
  {
    ...
    description: "You can edit issue details here. Click on fields to edit them.",
    priority: "Critical",
    status: "Open",
    createdAt: Date.now(),
  ...
  },
  {
    ...
    description: "You can change status of issues by dragging them into different lanes",
    priority: "High",
    status: "In Progress",
    createdAt: Date.now(),
    lastUpdated: Date.now(),
  ...
  },
  {
    ...
    description: "Click on delete icon to delete any issue",
    priority: "Medium",
    status: "Done",
    createdAt: Date.now(),
    lastUpdated: Date.now(),
