...
describe("IssuesComponent", () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [IssuesComponent, IssueListComponent, KanbanComponent, CreateIssueComponent],
  ...
  it("should show AppKanban when kanban is selected", async () => {
    const [kanbanButtonToggle, listButtonToggle] = await loader.getAllHarnesses(MatButtonToggleHarness);
